...
parser.add_argument('--output-dir', default=".", help="path to write new VM configuration file with no DataVolume")
parser.add_argument('--apply', action='store_true', default=False, help='directly apply changes rather than generating output. [WARNING] this includes deleting DataVolume objects')
...
vm.dv_to_pvc(apply=args.apply, output_dir=args.output_dir)
